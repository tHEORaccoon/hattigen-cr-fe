...
const DatabaseScreen = () => {
  ...
  return (
    <div className="container mx-auto ">
      <Header title={"Let’s add your Databases"} description={"Include frameworks you are experienced in and the number if months you have experience in them."} clicked={isEditing} onclick={handleEdit}/>
